      ...
      <>{
        ...
        <div className={classes.SideNaveBar}>
            ...
            <ul className={classes.sideMenu}>
              ...
              <li className={classes.navHeader}><i className="fas fa-user"></i> Tenant Management</li>
              <Link to="/admin/dashboard/manage/users"><li className={classes.navLink}>Manage tenants</li></Link>
